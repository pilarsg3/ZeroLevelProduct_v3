...
if __name__ == "__main__":
    ...
    parts = create_ihx(
        # Outer shell
        shell_outer_radius  = 0.5,
        shell_height        = 4.0,
        shell_wall_t        = 0.02,
        shell_bottom_t      = 0.02,

        # Upper neck
        neck_outer_radius   = 0.3,
        neck_wall_t         = 0.02,
        neck_height         = 1.0,

        # Inner cylinder
        inner_cyl_outer_radius = 0.2,
        inner_cyl_wall_t       = 0.015,
        inner_cyl_height       = 3.5,
        inner_cyl_z_bottom     = 0.5,

        # Funnel (simple taper: narrow at top, wide at bottom)
        funnel_profile = [
            (0.20, 3.0),
            (0.35, 1.5),
            (0.35, 1.0),
        ...
        # Lower tube bundle
        bundle_outer_od     = 0.40,
        bundle_outer_wall_t = 0.015,
        bundle_inner_od     = 0.20,
        bundle_inner_wall_t = 0.015,
        bundle_height       = 1.0,
        bundle_z_bottom     = 0.0,

        # Primary elbow pipe
        primary_pipe_od     = 0.10,
        primary_pipe_wall_t = 0.01,
        primary_R_bend      = 0.15,
        primary_L_vert      = 0.5,
        primary_L_horiz     = 0.6,
        ...
        # Side nozzle
        side_nozzle_od      = 0.08,
        side_nozzle_wall_t  = 0.008,
        side_nozzle_length  = 0.3,
        side_nozzle_z       = 2.0,
    )
    ...
    print("Parts built:", list(parts.keys()))
